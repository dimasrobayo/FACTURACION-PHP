<?php
    ...
    $query="SELECT * FROM solicitantes,tipo_solicitantes,cs_proyecto WHERE cs_proyecto.cedula_rif=solicitantes.cedula_rif and solicitantes.cod_tipo_solicitante=tipo_solicitantes.cod_tipo_solicitante order by cs_proyecto.cedula_rif";
                ...
                <tr align="center">
                    <th colspan="9" align="center">
                        <div id="cpanel">
                            ...
                            <div style="float:right;">
                                <div class="icon">
                                    <a href="index2.php?view=proyecto_load_add">
