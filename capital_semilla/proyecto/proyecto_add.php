<?php
    ...
    if (isset($_POST[save])){   // Insertar Datos del formulario
        ...
        if ($result_solicitantes[0]){
            $query="SELECT update_solicitante('$cedula','$cod_tipo_solicitante','$nombreapellido','$sexo','$fecha_nac','$direccion','$telefono','$celular','$email','$codcom','now()')";
            $result = pg_query($query)or die(pg_last_error());
            $result_update_solicitante=pg_fetch_array($result);
            pg_free_result($result);
        }else{
            $query="SELECT insert_solicitante('$cedula','$cod_tipo_solicitante','$nombreapellido','$sexo','$fecha_nac','$direccion','$telefono','$celular','$email','$codcom')";
            $result = pg_query($query)or die(pg_last_error());
    ...
    <div class="main">
        ...
        <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">        
            <table class="adminform"  width="100%" align="center">
                ...
                <tr>
                    <td class="titulo" align="left"><b>Información Básica del Solicitante:</b></td>
                </tr>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="12">
                                        <input class="validate[required] text-input" type="text" id="direccion" name="direccion" value="<?php echo $result_solicitantes[direccion_habitacion];?>"  size="120" maxlength="150"/>  
                                    </td>
                                </tr>
                ...
                <tr>
                    <td class="titulo" colspan="2" height="18"  align="left"><b>Información del Proyecto a Financiar:</b></td>
                </tr>
                    ...
                    <td colspan="2">
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td width="23%">
                                        Nombre del Proyecto: <font color="Red">(*)</font>
                                    </td>

                                    <td>
                                        <textarea class="validate[required]" name="nombre_proyecto" id="dnombre_proyecto" cols="68" rows="3" onkeyup=""></textarea>                                                                    
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        LUGAR DE EJECUCION:<font color="red">(*)</font>
                                    </td>

                                    <td>
                                        <input type="text" id="lugar_ejecucion" name="lugar_ejecucion" size="60" maxlength="60">
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        IMPACTO SOCIAL:<font color="red">(*)</font>
                                    </td>

                                    <td>
                                        <input type="text" id="impacto_social" name="impacto_social" size="60" maxlength="60">
                                    </td>
                                </tr>

                                <tr>
                                    <td>CLAP ASOCIADO: <font color="Red">(*)</font></td>

                                    <td >
                                        <div id="capital">
                                            <select name="capital" id="codigo_capital" class="validate[required]">
                                                <option selected="selected" value="">---</option>
                                                <?php 
                                                    $consulta_sql=pg_query("SELECT * FROM capital_semilla order by nombre_semilla");
                                                    while ($array_consulta=pg_fetch_array($consulta_sql)){                                                                                                                                              
                                                        echo '<option value="'.$array_consulta[0].'">'.$array_consulta[1].'</option>';                                                                          
                                                    }                                                                      
                                                    pg_free_result($consulta_sql);                              
                                ...
                                <tr>
                                    <td>CLAP ASOCIADO AL PROYECTO:<font color="Red">(*)</font></td>

                                    <td >
                                        <div id="clap">
                                            <select name="clap" id="codigo_clap" class="validate[required]">
                                                <option selected="selected" value="">---</option>
                                                <?php 
                                                    $consulta_sql=pg_query("SELECT * FROM clap order by nombre_clap");
                                                    while ($array_consulta=pg_fetch_array($consulta_sql)){                                                                                                                                              
                                                        echo '<option value="'.$array_consulta[0].'">'.$array_consulta[1].'</option>';                                                                          
                                                    }                                                                      
                                                    pg_free_result($consulta_sql);                              
                                ...
                                <tr>
                                    <td>SECTOR/RUBRO: <font color="Red">(*)</font></td>

                                    <td >
                                        <div id="rubro">
                                            <select name="rubro" id="codigo_rubro" class="validate[required]">
                                                <option selected="selected" value="">---</option>
                                                <?php 
                                                    $consulta_sql=pg_query("SELECT * FROM rubro order by descripcion");
                                                    while ($array_consulta=pg_fetch_array($consulta_sql)){                                                                                                                                              
                               ...
                               <tr>
                                    <td width="23%">
                                        DESCRIPCION DEL PROYECTO: <font color="Red">(*)</font>
                                    </td>

                                    <td>
                                        <textarea class="validate[required]" name="descripcion_proyecto" id="descripcion_proyecto" cols="68" rows="3" onkeyup=""></textarea>                                                                    
                                    </td>
                                </tr>

                                <tr>
                                    <td width="23%">
                                        FORTALEZAS DEL PROYECTO: <font color="Red">(*)</font>
                                    </td>

                                    <td>
                                        <textarea class="validate[required]" name="fortaleza_proyecto" id="fortaleza_proyecto" cols="68" rows="3" onkeyup=""></textarea>                                                                    
                                    </td>
                                </tr>
                ...
                <tr>
                    <td colspan="2" class="botones" align="center" >            
                        ...
                        <input  class="button" type="button" onclick="javascript:window.location.href='?view=proyecto_load_add'" value="Cerrar" name="cerrar" /> 
                    </td>                                                   
                </tr> 
