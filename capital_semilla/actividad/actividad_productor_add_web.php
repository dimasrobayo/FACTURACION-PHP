            ...
            <table class="adminform" border="0" width="100%">
                        ...
                        <div align="center"> 
                            <h3 class="info">	
                                <font size="2">	
                                    ...
                                    [<a href="?view=productor_load_web<?php echo '&cedula_rif='.$cedula_rif;?>" name="Continuar"> Continuar </a>]
                                </font>							
                            </h3>
                        </div> 
                    </td>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="validate[required,custom[date]]" name="fecha_siembra" type="text" value="<?php if ($error!="") echo implode('/',array_reverse(explode('-',$fecha_siembra)));?>"  id="fecha_siembra"  size="10" maxlength="10" onKeyPress="ue_formatofecha(this,'/',patron,true);"  />
                                        ...
                                        FECHA COSECHA:
                                        <input class="validate[required,custom[date]]" name="fecha_cosecha" type="text" value="<?php if ($error!="") echo implode('/',array_reverse(explode('-',$fecha_cosecha)));?>"  id="fecha_cosecha"  size="10" maxlength="10" onKeyPress="ue_formatofecha(this,'/',patron,true);"  />
                ...
                <tr>
                    <td colspan="2" class="botones" align="center" >			
                        ...
                        <input  class="button" type="button" onclick="javascript:window.location.href='?view=productor_load_web<?php echo '&cedula_rif='.substr_replace($cedula_rif,'-',1,0);?>'" value="Cerrar" name="cerrar" />  
                    </td>													
                </tr> 
            <?php }  ?>	
        </table>
