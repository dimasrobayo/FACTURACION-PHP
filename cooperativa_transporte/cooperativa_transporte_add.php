...
<?php 
    if (isset($_POST[save])) {   // Insertar Datos del formulario
        ...
        if (!$resultado[0]) {
            ...
            $query="insert into cooperativas_transporte values('$rif_cooperativa','$nombre_cooperativa','$direccion_cooperativa','$telefono_cooperativa','$persona_contacto_cooperativa','$telefono_persona_contacto_cooperativa','$cod_tipo_transporte_cooperativa','1')";
            $result = pg_query($query)or die(pg_last_error());
            ...
            $div_menssage='<div align="left">
                        <h3 class="error">
                            <font color="red" style="text-decoration:blink;">
                                Error: Ya Existe un Registro el RIF: <font color="blue">'.$rif_cooperativa.'</font>; por favor verifique los datos!
                            </font>
                        </h3>
                    </div>';	
        }
            ...
            <table class="adminform" border="0" width="100%">
                <tr>
                    <th colspan="2" align="center">
                        ...
                        INGRESAR DATOS DE LA COOPERATIVA
                    </th>
                </tr>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="85%">
                                        <input autofocus="true"  class="validate[required] text-input" value="<?php echo $rif_cooperativa;?>" type="text" id="rif_cooperativa" name="rif_cooperativa" maxlength="12" size="12"/>
                                    </td>                       
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input  class="validate[required] text-input" value="<?php echo $nombre_cooperativa;?>" type="text" id="nombre_cooperativa" name="nombre_cooperativa" maxlength="100" size="60"/>
                                    </td>			
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input class="validate[required] text-input" type="text" id="direccion_cooperativa" name="direccion_cooperativa" value="<?php echo $direccion_cooperativa;?>"  size="60" maxlength="150"/>	
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <input class="validate[custom[phone]] text-input" placeholder="(0212)-1234567" title="Ej.: (0212)-1234567" id="telefono_cooperativa" type="text" name="telefono_cooperativa" size="15" value="<?php echo $telefono_cooperativa;?>" maxlength="15"/>														
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="persona_contacto_cooperativa" name="persona_contacto_cooperativa" value="<?php echo $persona_contacto_cooperativa;?>" onkeyup="" size="50" maxlength="50"/>																	
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input class="validate[custom[phone]] text-input" placeholder="(0414)-1234567" title="Ej.: (0414)-1234567" id="telefono_persona_contacto_cooperativa" type="text" name="telefono_persona_contacto_cooperativa" size="15" value="<?php echo $telefono_persona_contacto_cooperativa;?>" maxlength="15"/>														
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <select name="cod_tipo_transporte_cooperativa" id="cod_tipo_transporte_cooperativa" class="validate[required]">
                                                ...
                                                <?php 
                                                    ...
                                                    while ($array_consulta=pg_fetch_array($consulta_sql)){
                                                        if ($array_consulta[0]==$cod_tipo_transporte_cooperativa){
