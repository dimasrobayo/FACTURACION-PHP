...
if (isset($_GET['codigo_tipo'])){
    $datos_modificar= $_GET['codigo_tipo'];
    ...
    $datos_consulta = pg_query("SELECT * FROM tipo_actividad where codigo_tipo = $datos_modificar") or die("No se pudo realizar la consulta a la Base de datos");
...
{//se resive los datos a ser modificados
    ...
    //se le hace el llamado a la funcion de insertar.	
    $inserta_registro = pg_query("SELECT update_tipo_actividad($codigo_tipo,'$descripcion')") or die("NO SE PUEDE MODIFICAR LOS DATOS EN LA BASE DE DATOS.");		
	...
	<table border="0" width="100%" align="center">
        ...
        <form method="POST" action="<?php echo $pagina?>" enctype="multipart/form-data">
            <table class="adminform" border="0" width="100%">
                <tr bgcolor="#55baf3">
                    <th colspan="3">
                        MODIFICAR DATOS DEL TIPO DE ACTIVIDAD
                    </th>
                </tr>    
                ...
                <tr>
                    ...
                    <td width="85%">
                        <input class="inputbox" type="text" id="codigo_tipo" name="codigo_tipo" readonly="true" value="<?php echo $resultados1[codigo_tipo]; ?>" maxlength="12" size="12"/>
