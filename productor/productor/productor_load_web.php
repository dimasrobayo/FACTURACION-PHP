...
<form method="POST" action="?view=productor_load_web" id="QForm" name="QForm" enctype="multipart/form-data">																				
            ...
            <td colspan="2" class="botones" align="center" >											
                ...
                <?php 
                    if (isset($_POST[submit]) AND ($total_result==0)  AND ($_SESSION[nivel]!=1)){
                        echo "<input  class=\"button\" type=\"button\" onclick=\"javascript:window.location.href='?view=productor_add_web&cedula_rif=$cedula_rif'\" value=\"AGREGAR REGISTRO\" name=\"cerrar\" /> ";
                    }
                ?>
            </td>			
        </tr>										   
       ...
       <tr>											
        ...
        <tr class="item_claro"> 
            ...
            <td align="center">
                ...
                <a href="index.php?view=productor_update_web&cedula_rif=<?php echo $resultados_solicitantes[cedula_rif];?>" title="Pulse para Modificar los datos registrados">
                    <img border="0" src="images/modificar.png" alt="borrar">
                </a>	      
                <a href="index.php?view=actividad_productor_add_web&cedula_rif=<?php echo $resultados_solicitantes[cedula_rif];?>" title="Pulse para Registrar un Ticket">
