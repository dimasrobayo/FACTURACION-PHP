...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    if (isset($_POST[save])){
        if ($_POST['personvalue1']!="") {
            ...
            $comunidad='<script> document.QForm.getElementById("codcom").value; </script>';
            $comunidad;
            ...
            echo "<script type=\"text/javascript\">
                    opener.document.QForm.ci_jefe_com.value='$cedula_rif';
                    opener.document.QForm.jefe_comunidad.value='$resultado_cliente[nombre_solicitante]' + ' ' + '$resultado_cliente[alapsolicitante]';
                    close();
                  </script>";
    ...
    //                      jQuery('#personvalue1').val(value.celular);
        ...
        <script language="JavaScript">
            function aceptar(cedula) {
                opener.document.QForm.codcom.value=cedula;
                close();
            }
        </script>
 ...
 <?php } ?>
    ...
    <table class="container_contenido_cat" border="0" width="100%" cellspacing="0" cellpadding="0">
        <tbody>  			
            <tr>
                <td>
                    <form method="POST" action="jefe_comunidad_load.php" id="QForm" name="QForm" enctype="multipart/form-data">
                    <table class="adminform_cat" width="100%"  align="center">
                        <tbody>
                            <tr>
                                <th align="center">
                                    BUSQUEDA DEL JEFE DE COMUNIDAD
                                </th>
                            </tr>
                            <tr>
                                <td>
