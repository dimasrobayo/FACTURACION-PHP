        ...
        <table class="adminform" border="0" width="100%">
                            ...
                            <font size="2">                     
                                ...
                                <script type="text/javascript">
                                    function redireccionar(){
                                        window.location="?view=clap";
                                    }  
                                    setTimeout ("redireccionar()", 3000); //tiempo de espera en milisegundos
                                </script>                       
                                [<a href="?view=clap" name="Continuar"> Continuar </a>]
                            </font>                         
                        </h3>
                    </div> 
                </td>
            ...
            <tr>
                <td colspan="2" class="botones" align="center" >            
                    ...
                    <input  class="button" type="button" onclick="javascript:window.location.href='?view=clap'" value="Cerrar" name="cerrar" />  
                </td>                                                   
            </tr> 
        <?php }  ?> 
        </table>
