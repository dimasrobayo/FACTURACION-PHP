    ...
    if (isset($_POST[save])){
        if ($_POST['personvalue1']!="") {
            ...
            echo "<script type=\"text/javascript\">
                    opener.document.QForm.ci_ffm.value='$cedula_rif';
                    opener.document.QForm.responsable_ffm.value='$resultado_cliente[nombre_solicitante]' + ' ' + '$resultado_cliente[apellido_solicitante]';
                    close();
                  </script>";
 ...
 <?php } ?>
    ...
    <table class="container_contenido_cat" border="0" width="100%" cellspacing="0" cellpadding="0">
        <tbody>  			
            <tr>
                <td>
                    <form method="POST" action="resp_francisco_load.php" id="QForm" name="QForm" enctype="multipart/form-data">
                    <table class="adminform_cat" width="100%"  align="center">
                        <tbody>
                            <tr>
                                <th align="center">
                                    BUSQUEDA DEL RESPONSABLE F. F. MIRANDA
                                </th>
                            </tr>
                            <tr>
                                <td>
