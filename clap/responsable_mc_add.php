...
<?php
    ...
    if (isset($_POST[save])) {
        ...
        echo "<script type=\"text/javascript\">
                    ...
                    opener.document.QForm.responsable_mc.value='$nombreapellido';
                    close();
                </script>";
 ...
 <?php } ?>
    ...
    <table class="container_contenido_cat" border="0" width="100%" cellspacing="0" cellpadding="0">
        <tbody>  			
            <tr>
                <td>
                    <form method="POST" action="responsable_mc_add.php" id="QForm" name="QForm" enctype="multipart/form-data">
