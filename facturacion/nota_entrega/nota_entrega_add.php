...
<?php 
    if (isset($_POST[save])){   // Insertar Datos del formulario
        ...
        if ($cedula_rif){  // consulta de los datos para Mostrar
            ...
            $query = "INSERT INTO nota_entrega (cedula_rif, cedula_usuario, responsable, chofer, placa) values ('$cedula_rif_buscar', '$cedula_usuario', '$responsable','$chofer','$placa')";  
...
<div align="center" class="centermain">
    <div class="main">
        ...
        <form id="facturacion" name="facturacion" method="POST" action="index2.php?view=nota_entrega_add" onSubmit="return validar_form_enviado();" enctype="multipart/form-data">                  
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="validate[required]" name="responsable" id="responsable" size="60" align="center" />
                                    </td>

                                    <td>
                                        CHOFER: <font color="Red">(*)</font>
                                        <input class="validate[required]" name="chofer" id="chofer" size="60" align="center" />
                                    </td>

                                    <td>
                                        N° DE PLACA: <font color="Red">(*)</font>
                                        <input class="validate[required]" name="placa" id="placa" size="12" align="center" />
                                    </td>
