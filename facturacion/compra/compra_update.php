...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    $query="SELECT * from solicitantes, tipo_solicitantes, compra, usuarios where solicitantes.cod_tipo_solicitante=tipo_solicitantes.cod_tipo_solicitante and solicitantes.cedula_rif=compra.cedula_rif and usuarios.cedula_usuario=compra.cedula_usuario and compra.codigo_compra=$codigo_compra order by codigo_compra";
    ...
    if (isset($_POST[save])) {
        ...
        $query="SELECT update_compra($codigo_compra, '$cedula_rif_buscar', '$n_factura', $cedula_usuario,'$fecha_compra')";
        $result = pg_query($query)or die(pg_last_error());
        $error="bien";     
...
<div align="center" class="centermain">
    ...
    <table border="0" width="100%" align="center">
        ...
        <form id="facturacion" name="facturacion" method="POST" action="index2.php?view=compra_update" onSubmit="return validar_form_enviado();" enctype="multipart/form-data">
            ...
            <table class="adminform" border="0" width="100%">
                <tr bgcolor="#55baf3">
                    <th colspan="2">
                        ...
                        MODIFICAR DATOS DE LA COMPRA A PROVEEDOR
                    </th>
                </tr>
        ...
        <?php   }else{  ?>   <!-- Mostrar formulario Original --> 
                ...
                <tr>
                    <td class="titulo" colspan="2" height="18"  align="left"><b>Datos de la Factura Proveedor:</b></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <tbody>
                        <input id="codigo_compra" name="codigo_compra" value="<?php echo $resultado[codigo_compra]; ?>" type="hidden"/>
                        <tr>
                            <td>
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                N° DE COMBOS: <font color="Red">(*)</font>
                                                <input class="validate[required,custom[number]]" name="n_factura" id="n_factura" size="15" align="center" value="<?php echo $resultado[n_factura]; ?>"/>
                                            </td>
