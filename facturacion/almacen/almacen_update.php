...
if (isset($_GET['codigo_almacen'])){
    $datos_modificar= $_GET['codigo_almacen'];
    ...
    $datos_consulta = pg_query("SELECT * FROM almacen_concepto where codigo_almacen = $datos_modificar") or die("No se pudo realizar la consulta a la Base de datos");
...
{//se resive los datos a ser modificados
    ...
    //se le hace el llamado a la funcion de insertar.	
    $inserta_registro = pg_query("SELECT update_almacen($codigo_almacen,'$nombre_almacen',$status)") or die("NO SE PUEDE MODIFICAR LOS DATOS EN LA BASE DE DATOS.");		
    ...
    <div class="main">  
        ...
        <form method="POST" action="<?php echo $pagina?>" enctype="multipart/form-data">
            <table class="adminform" border="0" width="100%">
                ...
                <tr>
                    <td class="titulo" colspan="2" height="18"  align="left"><b>Datos del Almacen:</b></td>
                </tr>
                
                <tr>
                    <td width="15%">
                        C&oacute;digo del Almacen:				
                    </td>

                    <td width="85%">
                        <input class="inputbox" type="text" id="codigo_almacen" name="codigo_almacen" readonly="true" value="<?php echo $resultados1[codigo_almacen]; ?>" maxlength="12" size="12"/>
                        <font color="#ff0000">*</font>
                        <script type="text/javascript">
                            var codigo = new LiveValidation('codigo_almacen');
                ...
                <tr>
                    ...
                    <td>
                        <input class="inputbox" type="text" id="nombre_almacen" name="nombre_almacen" value="<?php echo $resultados1[nombre_almacen]; ?>" maxlength="45" size="45"/>
                        <font color="#ff0000">*</font>
                        <script type="text/javascript">
                            var codigo = new LiveValidation('nombre_almacen');
                            codigo.add(Validate.Presence);
                        </script>
                    </td>						
                </tr>
                ...
                <tr width="15%">
                    ...
                    <td width="85%">
                        <select id="status" name="status" class="validate[required]" size="0">
                            <option value="<?php echo $resultados1[codigo_almacen]; ?>">--Selecciones para Modificar--</option>          
