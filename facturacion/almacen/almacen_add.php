...
else
{
    ...
    $inserta_registro = pg_query("insert into almacen_concepto (nombre_almacen, status) values ('$nombre_almacen', $status)") or die("NO SE PUEDE INSERTAR EL REGISTRO EN LA BASE DE DATOS.");	
        ...
        <form method="POST" action="<?php echo $pagina?>" enctype="multipart/form-data">
            <table class="adminform" border="0" width="100%">
                ...
                <tr width="15%">
                    ...
                    <td width="85%">
                        <input class="validate[required]" type="text" id="nombre_almacen" name="nombre_almacen" maxlength="45" size="45"/>
