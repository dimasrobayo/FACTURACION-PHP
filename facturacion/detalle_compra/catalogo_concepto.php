...
<?php
    ...
    $datos_consulta = pg_query("SELECT * FROM concepto_factura, marca_concepto WHERE concepto_factura.codigo_marca = marca_concepto.codigo_marca and concepto_factura.status=1 order by concepto_factura.codigo_concepto") or die("No se pudo realizar la consulta a la Base de datos");
?>
...
<?php
    ...
    {
        $query="SELECT * FROM detalle_compra WHERE codigo_compra=$codigo_compra and codigo_concepto='$resultados[codigo_concepto]'";				
...
?>
            ...
            <tr class="row0">
                ...
                <td  align="center">
                    <?php echo $resultados[iva_producto];?>
                </td>
