...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    if (isset($_POST[cargar])) {
        ...
        $query="insert into detalle_compra(codigo_compra,codigo_concepto,cantidad,monto_concepto,iva_facturado) values ('$codigo_compra','$codigo_concepto','$cantidad','$monto_concepto','$iva_facturado')";
        ...
        $solicitante="SELECT * from solicitantes, tipo_solicitantes, compra, usuarios where solicitantes.cod_tipo_solicitante=tipo_solicitantes.cod_tipo_solicitante and solicitantes.cedula_rif=compra.cedula_rif and usuarios.cedula_usuario=compra.cedula_usuario and compra.codigo_compra=$codigo_compra order by compra.codigo_compra";
        ...
        $detalle_consolta = pg_query("SELECT * from compra, detalle_compra, concepto_factura, marca_concepto where compra.codigo_compra=detalle_compra.codigo_compra and concepto_factura.codigo_concepto=detalle_compra.codigo_concepto and marca_concepto.codigo_marca = concepto_factura.codigo_marca and detalle_compra.codigo_compra=$codigo_compra order by detalle_compra.codigo_compra")or die('La consulta fall&oacute;: ' . pg_last_error());
        pg_close();
    }

    if (isset($_GET['codigo_compra'])){
...
<div align="center" class="centermain">
    ...
    <table class="adminform" border="0" width="100%">
        ...
        <tr bgcolor="#55baf3">
            <th colspan="2">
                GENERAR NOTAS DE ENTREGA: <font color="red"><?php echo $resultado_solicitante[codigo_compra]; ?></font>
            </th>
        </tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <tbody>
                <input id="codigo_compra" name="codigo_compra" value="<?php echo $resultado_solicitante[codigo_compra]; ?>" type="hidden"/>
                <tr>
                    <td>
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        N° DE FACTURA: <font color="Red">(*)</font>
                                        <input class="validate[required,custom[number]]" name="n_factura" id="n_factura" size="15" align="center" value="<?php echo $resultado_solicitante[n_factura]; ?>" readonly/>
                                    </td>
    ...
    <table class="adminform" border="0" width="100%">
        ...
        <input id="codigo_compra" name="codigo_compra" value="<?php echo $resultado_solicitante[codigo_compra]; ?>" type="hidden"/>
        <input id="n_factura" name="n_factura" value="<?php echo $resultado_solicitante[n_factura]; ?>" type="hidden"/>
        ...
        <tr>
            <td>
                ...
                <input type="text" placeholder="Código Concepto" id="codigo_concepto" name="codigo_concepto" maxlength="15" size="15" onblur="cargarContenedorConcepto()" onkeyup="cargarContenedorConcepto()"/>
                    <a href="javascript: ventanaconceptoscompras();">
        ...
        <tr class="row0">
            ...
            <td align="center"> 
                <a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?view=detalle_compra_drop&codigo_compra=<?php echo $resultados_detalles[codigo_compra];?>&codigo_concepto=<?php echo $resultados_detalles[codigo_concepto];?>&cantidad=<?php echo $resultados_detalles[cantidad];?>&n_factura=<?php echo $resultados_detalles[n_factura];?>&stock=<?php echo $resultados_detalles[stock];?>&status_stock=<?php echo $resultados_detalles[status_stock];?>" title="Pulse para eliminar el registro">
                        ...
                        <td width="100%">
                            <div id="cpanel">
                                <div style="float:left;">
                                    <div class="icon">
                                        <a href="reportes/imprimir_compra.php?codigo_compra=<?php echo $resultado_solicitante[codigo_compra]; ?>" target="_blank">
