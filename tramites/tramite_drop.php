...
<?php 
    if (isset($_GET['cod_tramite'])){
        ...
        $query="SELECT * FROM tramites WHERE tramites.cod_tramite ='$datos_borrar' AND tramites.cod_tramite IN (SELECT cod_tramite FROM detalles_ticket WHERE detalles_ticket.cod_tramite ='$datos_borrar') OR tramites.cod_tramite IN (SELECT cod_tramite FROM ticket WHERE ticket.cod_tramite ='$datos_borrar')";			
...
<div align="center" class="centermain">
    <div class="main">  
        <table class="admintramites" width="100%">
            <tr>
                <th>
                    TRAMITE DEL DEPARTAMENTO/UNIDAD:
                </th>
            </tr>
        </table>
