            ...
            <table class="adminform"  width="100%" align="center">
                <tr>
                    <th colspan="2" align="center">
                        ...
                        ESCALANDO ACTUACIÓN SOBRE  EL TICKET
                    </th>
                </tr>
                    ...
                    <td colspan="2">
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <td width="15%">
                                    ESCALAR TICKET A: <font color="Red">(*)</font>
                                </td>
                                <td>
                                    <div id="unidades">
...
<!--                                                    <td width="220">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="validate[required]"  name="situacion_actual" id="situacion_actual" cols="84" rows="2" >SE ESCALA LA SOLICITUD A OTRA UNIDAD</textarea>																	
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <textarea class="validate[required]" placeholder="ESCRIBA AQUI LAS RAZONES POR LA QUE SE HACE NECESARIO ESCALAR EL REQUERIMIENTO A OTRA UNIDAD"   name="actuacion" id="actuacion" cols="84" rows="2" ><?php echo $resultados_ticket['descripcion_ticket']?></textarea>																	
                                    </td>
                                </tr>
