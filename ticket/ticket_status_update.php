...
//        $fecha_atencion=implode('-',array_reverse(explode('/',$_POST['fecha_atencion']))); 
...
//        $hora_desde=date("H:i", mktime($thorad,$tminutosd,0));
        ...
        $sms=$resultados_empresa[sms_actualizar_ticket];
            ...
            <table class="adminform"  width="100%" align="center">
                <tr>
                    <th colspan="2" align="center">
                        ...
                        ACTUALIZANDO LA ULTIMA ACTUACIÓN SOBRE  EL TICKET
                    </th>
                </tr>
                    ...
                    <td colspan="2">
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <td width="15%">
                                        FECHA CITA: <font color="Red">(*)</font>
                                    </td>
                                    <td>
                                        <table  border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody>
...
<!--                                                    <td width="220">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="validate[required]"  name="situacion_actual" id="situacion_actual" cols="84" rows="2"  >SE PROGRAMO  CITA PARA LA ATENCIÓN DEL REQUERIMIENTO</textarea>																	
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <textarea class="validate[required]" placeholder="ESCRIBA AQUI LAS RAZONES POR LA QUE SE HACE NECESARIO PROGRAMAR CITA PARA LA ATENCIÓN DEL REQUERIMIENTO"   name="actuacion" id="actuacion" cols="84" rows="2" ><?php echo $resultados_ticket['descripcion_ticket']?></textarea>																	
                                    </td>
                                </tr>
