                ...
                <div id="myMenuID">
                    ...
                    [
                        ...
                        ['<img src="images/iconos/file.png" />', 'Archivos', null, null, 'Archivos',
                            ...
                            _cmSplit,
                            ['<img src="images/menu/mnurpt_banco.png" />', 'Cooperativas de transporte', "index2.php?view=cooperativas_transporte", null, 'Registro-Control de Cooperativas de Transporte'],			
                        ],
                        _cmSplit,
                        ...
                        ['<img src="images/iconos/imprimir.png" />',' Reportes',null,null,'Reportes generales del Sistema',
                            ...
                            ['<img src="images/menu/reporte.png" />', 'Reportes Específicos', null, null,
                                _cmSplit,
                                ['<img src="images/iconos/ver_detalle.png" />', 'Listado de Ticket por Fecha', "index2.php?view=gestion_reporte_ticket_fecha", null,'Listado de Ticket por Fecha'],
                                _cmSplit,
