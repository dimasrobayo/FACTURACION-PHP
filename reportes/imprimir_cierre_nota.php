<?php
    ...
    $query= "Select *, lpad(to_char(nota_entrega.codigo_nota,'0999999'),8,'0') AS codigo_nota from nota_entrega, solicitantes where nota_entrega.cedula_rif=solicitantes.cedula_rif";
    ...
    $query = "Select * from nota_entrega, detalle_nota,concepto_factura where nota_entrega.fecha_nota = '$fecha_cierre' and nota_entrega.codigo_nota = detalle_nota.codigo_nota and detalle_nota.codigo_concepto=concepto_factura.codigo_concepto";
    ...
    while ($row=pg_fetch_array($result_detalle)){
        ...
        $n_factura=$row["codigo_nota"];
        $pdf->Cell(22,5,$row["codigo_nota"],'LR',0,'C');
        ...
        $importet=$importet+$importe*$n_combo;
