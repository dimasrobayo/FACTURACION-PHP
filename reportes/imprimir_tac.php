<?php
    ...
    $query="SELECT * FROM cooperativas_transporte WHERE rif_cooperativa='$resultados_ticket[rif_cooperativa]'";
    $result = pg_query($query)or die(pg_last_error());
    $resultados_cooperativa=pg_fetch_array($result);	
    pg_free_result($result);
...
//    $pdf->SetFontSize(9);
    ...
    $pdf->SetFont('Times','B',9);
    $pdf->Cell(75,4,utf8_decode('EMPRESA DE TRANSPORTE'),1,0,'C',0);
	...
	$pdf->Cell(75,5,utf8_decode($resultados_cooperativa[nombre_cooperativa]),1,0,'L',0);
    ...
    $pdf->SetY(85);
    $pdf->Cell(40,5,utf8_decode('Total monto a depositar:'),0,0,'L',0);
    $pdf->SetFont('','B');
...
//    $pdf->Cell(55);
//    $pdf->SetFont('');
//    $pdf->Cell(30,5,utf8_decode('Monto a Depositar:'),0,0,'L',0);
//    $pdf->SetFont('','B');
//    $pdf->Cell(20,5,utf8_decode($resultados_detalle_ticket['monto_autorizado']),0,0,'L',0);
